  ...
  return (
    <div className="flex flex-col items-center gap-5">
      ...
      <ul className="relative flex h-[200px] w-[439px] flex-col items-center justify-center gap-2 overflow-hidden bg-cover drop-shadow-2xl">
        <li className="background-item suit text-center italic sm:bg-[url('/Image/wave.jpeg')]"></li>
        <li className="suit text-center italic">
          <p className="shadow-inner">phone </p>
          <p>010-9724-3290</p>
        </li>
        <li className="suit flex items-center justify-evenly gap-2 text-center italic">
          <p>Github </p>
          <Link
            target="_blank"
